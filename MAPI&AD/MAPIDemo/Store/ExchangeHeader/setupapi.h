...
extern INT   APIENTRY CbGetSymbolValue(LPSTR szSymbol, LPSTR szValue,
				INT Length);
extern USHORT   APIENTRY UsGetListLength(LPSTR szSymbol);
...
#endif
#ifdef WIN32
extern LONGLONG APIENTRY LcbGetCopyListCost(LPSTR szExtraList, LPSTR szCostList,
				LPSTR szNeedList);
#endif
...
extern INT   APIENTRY FPrependToPath(LPSTR szSrc, LPSTR szDst, LPSTR szDir,
				INT cmo);
extern INT   APIENTRY SetEnvVariable(LPSTR szName, LPSTR szValue, int cmo);
...
extern INT  InitSetupToolkitEx(LPSTR szCmdLine, BOOL fUse3D);
...
extern INT   InitInstallEx(BOOL fUse3D);
...
extern VOID  MakeListFromSectionRename(LPSTR szSym, LPSTR szSect);
...
#endif
#ifdef WIN32
extern LONGLONG GetCopyListCost(LPSTR szExtraList, LPSTR szCostList,
				LPSTR szNeedList);
#endif
