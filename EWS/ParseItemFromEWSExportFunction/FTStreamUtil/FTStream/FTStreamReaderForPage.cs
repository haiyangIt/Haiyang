        ...
        private bool CanReadData(int length)
        {
            if(_reader == null || _reader.Position + length > _reader.Length)
            {
                ...
                else
                {
                    ...
                    do
                    {
                        FTStreamParseContext.Instance.WriteLine("---------------------------------------------------------------------------------------------------");
                        FTStreamParseContext.Instance.WriteLine("current page is end. will read next page");
                        FTStreamParseContext.Instance.WriteLine("---------------------------------------------------------------------------------------------------");
                        ...
                        FTStreamParseContext.Instance.WriteLine("---------------------------------------------------------------------------------------------------");
                        FTStreamParseContext.Instance.Write("next page bytes index is :");
                        FTStreamParseContext.Instance.Write(_ftPage.CurrentPageIndex.ToString());
                        FTStreamParseContext.Instance.Write(". Length is :");
                        FTStreamParseContext.Instance.WriteLine(bufferTemp.Length.ToString());
                        FTStreamParseContext.Instance.WriteLine("---------------------------------------------------------------------------------------------------");
                    } while (reading > 0);
