...
namespace EWSUtil
{
    public class ValidationCallbackHelper
    {
                 ...
                 System.Net.Security.SslPolicyErrors sslPolicyErrors)
        {
            ...
            {
                LogWriter.Instance.WriteLine(string.Format("SSL certificate validation failed, System.Net.Security.SslPolicyErrors = '{0}'",
            ...
            System.Security.Cryptography.X509Certificates.X509Chain chain)
        {
            ...
            LogWriter.Instance.WriteLine(string.Format("SSL Certificate detail:{0}", certificateDetail.ToString()));
        }
        ...
        public static bool RedirectionUrlValidationCallback(string redirectionUrl)
        {
            ...
            {
                LogWriter.Instance.WriteLine(string.Format("Unsafe URL redirection blocked, detail: Cannot allow potentially unsafe redirection to non-SSL URL:{0}.", redirectionUrl));
            ...
            LogWriter.Instance.WriteLine(string.Format("{0} URL:{1}.", GlobalSettings.AllowAutodiscoverRedirect ? "Allow URL redirection" : "Blocked URL redirection to", redirectionUrl));
