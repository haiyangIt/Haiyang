...
namespace Arcserve.Office365.Exchange.DataProtect.Impl
{
    ...
    public class CatalogService : ArcJobBase, ICatalogService, ICatalogJob, IDisposable
    {
        ...
        public CatalogService(string adminUserName, string adminPassword, string domainName, string organizationName)
        {
            ...
            _serviceContext = Arcserve.Office365.Exchange.DataProtect.Impl.Context.ServiceContext.NewServiceContext(AdminInfo.UserName, AdminInfo.UserPassword, AdminInfo.UserDomain, AdminInfo.OrganizationName, TaskType.Catalog);
        }
