...
{
    public class CollectionPatitionUtil<T>
    {
        public CollectionPatitionUtil(Func<T, int> funcGetSize)
        {
    ...
    public class PartitionList<TElement>
    {
        ...
        private EachPartition<TElement> GetUnFinishResult(bool isSmall)
        {
            if (isSmall)
            {
                return GetCollection(SmallCollections, CollectionPatitionUtil<TElement>.SmallCountInPartition, isNeedNewSmall);
            }
            else
            {
                return GetCollection(LargeCollections, CollectionPatitionUtil<TElement>.LargeCountInPartition, isNeedNewLarge);
            }
        }
        ...
        {
            var result = MergeTwoCollections(CollectionPatitionUtil<TElement>.Convert(SmallCollections), CollectionPatitionUtil<TElement>.Convert(LargeCollections),
                CollectionPatitionUtil<TElement>.SmallCountInPartition, CollectionPatitionUtil<TElement>.LargeCountInPartition);
        ...
        {
            var result = MergeTwoCollections(CollectionPatitionUtil<TElement>.Convert(SmallCollections), CollectionPatitionUtil<TElement>.Convert(LargeCollections), CollectionPatitionUtil<TElement>.SmallCountInPartition, CollectionPatitionUtil<TElement>.LargeCountInPartition);
            SmallCollections.Clear();
            LargeCollections.Clear();
            return result;
        }
