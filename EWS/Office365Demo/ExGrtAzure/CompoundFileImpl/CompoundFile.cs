...
namespace CompoundFileImpl
{
    public class CompoundFile
    {
        ...
        //public CompoundFile(string filePathForRead)
        //{

        //}

        public CompoundFile(string filePathForCreate, Guid rclsid)
        {
        ...
        //public CompoundFile(string fileName, int stgmMode)
        //{
