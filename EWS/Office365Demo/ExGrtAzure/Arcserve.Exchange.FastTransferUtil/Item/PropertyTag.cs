...
namespace Arcserve.Exchange.FastTransferUtil.Item
{
    public class PropertyTag : IPropTag
    {
        ...
        private static void Init()
        {
            ...
            _fixedTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_I2);
            _fixedTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_I8);
            _fixedTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_LONG);
            _fixedTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_R4);
            _fixedTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_DOUBLE);
            _fixedTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_CURRENCY);
            _fixedTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_APPTIME);
            _fixedTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_BOOLEAN);
            _fixedTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_SYSTIME);
            _fixedTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_CLSID);

            _varTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_STRING8);
            _varTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_UNICODE);
            _varTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_SERVERID);
            _varTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_OBJECT);
            _varTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_BINARY);

            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_I2);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_LONG);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_R4);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_DOUBLE);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_CURRENCY);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_APPTIME);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_SYSTIME);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_STRING8);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_BINARY);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_UNICODE);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_CLSID);
            _mvTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_I8);

            _mvVarTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_UNICODE);
            _mvVarTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_STRING8);
            _mvVarTypeHash.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_MV_BINARY);

            _mvFixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_I2, 2);
            _mvFixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_I8, 8);
            _mvFixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_LONG, 4);
            _mvFixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_R4, 4);
            _mvFixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_DOUBLE, 8);
            _mvFixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_CURRENCY, 8);
            _mvFixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_APPTIME, 8);
            //_fixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_BOOLEAN, );
            _mvFixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_SYSTIME, 8);
            _mvFixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_CLSID, 16);

            foreach(var keyvalue in _mvFixedTypeLengthDic)
            {
                _fixedTypeLengthDic.Add(keyvalue.Key, keyvalue.Value);
            }
            _fixedTypeLengthDic.Add((UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_BOOLEAN, 1);
            #endregion
        }
        ...
        {
            return propertyTag.PropertyType == (UInt16)Arcserve.Exchange.FastTransferUtil.Item.PropertyType.PT_CLSID;
        }
