...
namespace Arcserve.Exchange.FastTransferUtil
{
    ...
    public class LogWriter : IDisposable
    {
        ...
        private LogWriter()
        {
            //try
            //{
            //    var logFile = Arcserve.Exchange.FastTransferUtil.Build.Implement.BuildConst.LogFileName;
            //    Debug.WriteLine(logFile);

            //    _logwriter = new StreamWriter(Arcserve.Exchange.FastTransferUtil.Build.Implement.BuildConst.LogFileName, true);
