    ...
    public class EwsTraceListener : ITraceListener
    {
        ...
        public void Trace(string traceType, string traceMessage)
        {
            if (traceType == "EwsResponseHttpHeaders")
            {
                ...
                {
                    LogFactory.EwsTraceLogInstance.WriteLog(LogLevel.DEBUG, "X-DiagInfo", diagInfo);
                ...
                {
                    LogFactory.EwsTraceLogInstance.WriteLog(LogLevel.DEBUG, "RequestId", requestId);
                    this.LastRequestIdHeader = requestId;
                }
            }

            LogFactory.EwsTraceLogInstance.WriteLog(LogLevel.DEBUG, traceType, traceMessage);
        }
